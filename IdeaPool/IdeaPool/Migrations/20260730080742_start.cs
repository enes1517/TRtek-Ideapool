    ...
    public partial class start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "FikirDegerlendirme", "Fikir ve önerileri değerlendirme yetkisi" },
                    { 2, "KullaniciYetkiEkleme", "Kullanıcılara yeni yetki tanımlama yetkisi" },
                    { 3, "KullaniciYetkiSilme", "Kullanıcılardan yetki kaldırma yetkisi" }
                });
